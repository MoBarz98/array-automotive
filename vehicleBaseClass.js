const VehicleModule = require("./mecurySedan.js")
...
class Vehicle {
    ...
    loadPassenger() {
        if (this.maximumPassengers > 6){
            return this.maximumPassengers = true;
            console.log("enough seats...");
        } else {
            return this.maximumPassengers = false;
    ...
    scheduleService() {
        if (this.mileage > 30000) {
            ...
            console.log("time for maintinance...!!!");
        } else {
